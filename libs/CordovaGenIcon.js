...
CordovaGenIcon.prototype.generateIOSIcon = function(name, src, platforms, clbk) {
  var dests = [{
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon.png",
      width: 57, height: 57
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-40.png",
      width: 40, height: 40
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-50.png",
      width: 50, height: 50
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-72.png",
      width: 72, height: 72
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-76.png",
      width: 76, height: 76
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-small.png",
      width: 29, height: 29
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/iTunesArtwork.png",
      width: 512, height: 512
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon@2x.png",
      width: 114, height: 114
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-40@2x.png",
      width: 80, height: 80
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-50@2x.png",
      width: 100, height: 100
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-57@2x.png",
      width: 114, height: 114
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-60@2x.png",
      width: 120, height: 120
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-60@3x.png",
      width: 180, height: 180      
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-72@2x.png",
      width: 144, height: 144
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-76@2x.png",
      width: 152, height: 152
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-small@2x.png",
      width: 58, height: 58
  }, {
      dest: platforms + "/ios/" + name + "/Images.xcassets/AppIcon.appiconset/icon-small@3x.png",
      width: 87, height: 87
  }];
...
CordovaGenIcon.prototype.generateWindowsPhone8Icon = function(name, src, platforms, clbk) {
  ...
  {
      dest: platforms + "/wp8/Background.png",
